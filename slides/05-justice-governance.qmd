...
Chapter 4 connects DEIJ to three practical concerns:
...
::: notes
Time: 3 minutes. Avoid treating these as recruitment-only questions. The chapter connects professional composition and institutional culture to the ability to recognize problems, build relationships, and act effectively.
:::
...
Chapter 5 identifies foundations that can pull a decision in different directions:
...
::: notes
Time: 3 minutes. Link this back to Chapter 2's funding legacy. The point is not that one source is inherently good or bad; it is that funding is part of governance and affects capacity and accountability.
:::
...
The Chapter 4 guidelines ask professionals to:
