...
date: "Last updated: Sept 18, 2026"
filters:
  - ../source-footer.lua
format:
  revealjs:
...
2. connect a Human Well-being Vital Sign, measure, and affected perspective;
3. recommend an implementation or coordination action and a tradeoff; and
4. state a possible monitoring result and how you would revise the plan.

**Submit:** role record + four sections (200–350 words) before class ends.
Each present member then completes the private Group Check.
...
to justify a proposed decision and a revision trigger. Distinguish proposals from
case facts. The shared response uses the common four-criterion rubric (80
points); each present member, including the submitter, completes the private
Group Check at the end of class (20 points).
:::
